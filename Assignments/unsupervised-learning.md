...
2. Understand the importance of rotations and cluster selection
...
1. **Dataset Exploration**  
   - Load and examine the **Can Path Student Dataset (Imputed)**.  
...
3. **Rotations and Cluster Selection Tuning**  
   - Identify key decisions related to rotations and cluster selection.
